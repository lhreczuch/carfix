...
def report_pdf(request, pk):
    ...
    data = [['time','user','type','description']] 

    for log in logs:
        utc_time_str = datetime.fromisoformat(str(log.time))
        utc_time = datetime.fromisoformat(str(utc_time_str))
        ...
        row = [
            ...
            Paragraph(str(log.user), style_normal), 
